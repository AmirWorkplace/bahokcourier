            ...
            <div class="card">
                <div class="card-header px-3 py-2">
                    <div class="d-flex justify-content-between align-items-center">
                        <h6 class="h6 mb-0 text-uppercase">Privacy Edit</h6>
                        <a href="{{ Route('admin.privacy.index') }}" class="btn btn-primary btn-sm text-uppercase">Go
                            Back</a>
                    </div>
                </div>
                <div class="card-body p-4">
                    <div class="row g-3">
                        <div class="col-12">
                            <label for="title" class="form-label require"><b>Privacy Name</b></label>
                        ...
                        <div class="col-12">
                            <label for="description" class="form-label"><b>Privacy Description</b></label>
