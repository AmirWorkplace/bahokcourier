...
<div class="row g-3">
    <div class="col-12">
        <form action="{{ Route('admin.accordion.store') }}" method="POST" enctype="multipart/form-data" id="accordion-form">
            @csrf
            <div class="card">
                <div class="card-header px-3 py-2">
                    <div class="d-flex justify-content-between align-items-center">
                        <h6 class="h6 mb-0 text-uppercase">Add Main Area Setup</h6>
                        <a href="{{ Route('admin.accordion.index') }}" class="btn btn-primary btn-sm text-uppercase">
                            Go Back
                        </a>
                    </div>
                </div>
                <div class="card-body p-4">
                    <div class="row g-3">
                        <div class="col-12">
                            <label for="title" class="form-label require"><b>Accordion Title</b></label>
