...
@section('content')
    <div class="row g-3">
        <div class="col-12">
            <form action="{{ $form_link }}" method="POST" id="store_form" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-header p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <h6 class="h6 mb-0 text-uppercase">Add New Blog</h6>
                            <a href="{{ Route('admin.portfolio.index') }}" class="btn btn-primary btn-sm text-uppercase">Go
                                Back</a>
                        </div>
                    </div>
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control custom-input" id="title" name="title"
                                    required value="{{ old('title') }}" placeholder="Blog Title">
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control custom-input" id="tags" name="tags"
                                    required placeholder="tags" value="{{ old('tags') }}">
                            </div>
                            <div class="col-12">
                                <label for="short_description" class="form-label"><b>Short Description</b></label>
                                <textarea name="short_description" id="short_description" class="form-control" cols="30" required
                                    rows="4">{!! old('short_description') !!}</textarea>
                            </div>
                            <div class="col-12">
                                <label for="description" class="form-label"><b>Description</b></label>
                                <textarea name="description" id="description" class="description" cols="30" required rows="10">{!! old('description') !!}</textarea>
                            </div>
                            <div class="col-12">
