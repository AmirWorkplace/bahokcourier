...
<div class="row g-3">
    <div class="col-12">
        <form action="{{ Route('admin.about-faq.store') }}" method="POST" enctype="multipart/form-data" id="about-faq-form">
            @csrf
            <div class="card">
                <div class="card-header px-3 py-2">
                    <div class="d-flex justify-content-between align-items-center">
                        <h6 class="h6 mb-0 text-uppercase">Add About Faq Setup</h6>
                        <a href="{{ Route('admin.about-faq.index') }}" class="btn btn-primary btn-sm text-uppercase">
                            Go Back
                        </a>
                    </div>
                </div>
                <div class="card-body p-4">
                    <div class="row g-3">
                        <div class="col-12">
                            <label for="title" class="form-label require"><b>About Faq Name</b></label>
                        ...
                        <div class="col-12">
                            <label for="short_description" class="form-label"><b>About Faq Description</b></label>
