            ...
            <div class="card">
                <div class="card-header px-3 py-2">
                    <div class="d-flex justify-content-between align-items-center">
                        <h6 class="h6 mb-0 text-uppercase">Branch Edit</h6>
                        <a href="{{ Route('admin.branch.index') }}" class="btn btn-primary btn-sm text-uppercase">Go
                            Back</a>
                    </div>
                </div>
                <div class="card-body p-4">
                    <div class="row g-3">
                        <div class="col-md-4 col-sm-6">
                            ...
                            <input type="text" value="{{ $data->name }}" class="form-control custom-input" id="name"
                                name="name" required>
                        </div> 
                        <div class="col-md-4 col-sm-6">
                            <label for="primary_email" class="form-label require"><b>Primary Email</b></label>
                            <input type="text" value="{{ $data->primary_email }}" class="form-control custom-input" id="primary_email"
                                name="primary_email" required>
                        </div>   
                        <div class="col-md-4 col-sm-6">
                            <label for="secondary_email" class="form-label require"><b>Secondary E-mail</b></label>
                            <input type="text" value="{{ $data->secondary_email }}" class="form-control custom-input" id="secondary_email"
                                name="secondary_email">
                        </div>   
                        <div class="col-md-4 col-sm-6">
                            <label for="primary_phone" class="form-label require"><b>Primary Phone</b></label>
                            <input type="text" value="{{ $data->primary_phone }}" class="form-control custom-input" id="primary_phone"
                                name="primary_phone" required>
                        </div>   
                        <div class="col-md-4 col-sm-6">
                            <label for="secondary_phone" class="form-label require"><b>Secondary Phone</b></label>
                            <input type="text" value="{{ $data->secondary_phone }}" class="form-control custom-input" id="secondary_phone"
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="address" required id="address" cols="30" rows="4" placeholder="Write Address" class="form-control">{{ $data->address }}</textarea>
                        </div>  
                    </div>
                </div>
