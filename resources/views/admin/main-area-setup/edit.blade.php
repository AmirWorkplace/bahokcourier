...
<div class="row g-3">
    <div class="col-12">
        <form action="{{ Route('admin.main-area-setup.update', $data->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card">
                <div class="card-header px-3 py-2">
                    <div class="d-flex justify-content-between align-items-center">
                        <h6 class="h6 mb-0 text-uppercase">Main Area Setup Edit</h6>
                        <a href="{{ Route('admin.main-area-setup.index') }}" class="btn btn-primary btn-sm text-uppercase">Go
                            Back</a>
                    </div>
                </div>
