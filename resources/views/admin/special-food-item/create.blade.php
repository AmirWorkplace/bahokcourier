            ...
            <div class="card">
                <div class="card-header px-3 py-2">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ Route('admin.special-food-item.index') }}" class="btn btn-primary btn-sm text-uppercase">
                            Go Back
                        </a>
                    </div>
                </div>
                <div class="card-body p-4">
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" placeholder="name" class="form-control custom-input" id="name" name="name">
                        </div> 
                        <div class="col-12">
