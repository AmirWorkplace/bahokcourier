...
class DeliveryDetailsController extends Controller
{
    ...
    public function __construct(){
        $this->path = 'delivery-details';
        $this->table = 'delivery_details';
    }
    public function index()
    {
        return helperClass::resourceDataView(DeliveryDetails::query(), ['title', 'serial', /* 'short_description' */], null, $this->path);
    }
